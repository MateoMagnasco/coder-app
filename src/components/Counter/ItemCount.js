...
return (<div  className="divCounter">
  ...
  <p align="center" className="quantity"> {quantity} </p>
  <button onClick={onRemove} type="button" className="btn btn-primary">-</button>
  <button onClick={onAddCart} type="button" disabled={quantity === 0} className="btn btn-primary">Agregar al carrito</button>
